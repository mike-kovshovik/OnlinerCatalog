...
public class TestData {
	...
	public static final String numberOfFoundItemsText = "Найдено %s товаров";  // TODO to define locator
	public static final String onlinerHomePage = "http://onliner.by";
	public static final int numberOfFoundItems = 28;
	public static final String goodsToCompareText = "%s товара в сравнении";
	public static final int productIndexThree = 3;
	public static final int numberOfItemsToCompare = 4;
